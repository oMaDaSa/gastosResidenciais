...
Form to add a recurrence (either income or expense)/(monthly, weekly or daily) for a selected user.

![Add Recurrence](./screenshots/add_recurrence.png)

---

#### 📄 User Recurrences

Displays the list of recurrences for a specific user.

![User Recurrences](./screenshots/user_recurrences.png)
